...
enum BLEProtocol {
    /// Base 128-bit service UUID; characteristic index is substituted into `f001000X-...`.
    static let serviceUUID = CBUUID(string: "f0010000-1a2b-4c3d-8e5f-000000000000")

    /// Characteristic UUIDs keyed by purpose.
    enum CharUUID {
        static let control = CBUUID(string: "f0010001-1a2b-4c3d-8e5f-000000000000")
        static let ecg = CBUUID(string: "f0010002-1a2b-4c3d-8e5f-000000000000")
        static let bioz = CBUUID(string: "f0010003-1a2b-4c3d-8e5f-000000000000")
        static let ppg = CBUUID(string: "f0010004-1a2b-4c3d-8e5f-000000000000")
        static let metrics = CBUUID(string: "f0010005-1a2b-4c3d-8e5f-000000000000")
    }
